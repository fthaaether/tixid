...
@section('content')
    <div class="card w-50 d-block mx-auto my-5 p-4">
        <div class="card-body">
            ...
            <img src="{{ asset('storage/' . $ticket['ticketPayment']['qrcode']) }}" alt="" class="d-block mx-auto mb-3"
                style="width: 200px">
            <table class="w-100">
                <tr>
                ...
                <tr>
                    <td>Promo</td>
                    @if ($ticket['promo'])
                                <td><b>{{ $ticket['promo']['type'] == 'percent' ? $ticket['promo']['discount'] . '%' : 'Rp.' .
                        number_format($ticket['promo']['discount'], 0, ',', '.') }}</b></td>
                    @else
                        <td><b>-</b></td>
                    @endif
