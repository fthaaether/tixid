...
@section('content')
            ...
            @foreach ($rows as $row)
                ...
                <div class="d-flex justify-content-center">
                    @foreach ($cols as $col)
                        ...
                        @endif
                        <div
                            style="background: #112646; color: white; width: 40px; height: 35px; margin: 5px;
    ...
    <div class="fixed-bottom">
        <div class="w-100 bg-light text-center py-3" style="border: 1px solid black">
            ...
            <input type="hidden" name="schedule_id" id="user_id" value="{{ $schedule->id }}">
...
<script>
    ...
    function createOrder() {
        let data = {
            user_id: document.querySelector("#user_id").val(), //ambil value dari input:hidden id="user_id"
